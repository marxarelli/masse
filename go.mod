...
require (
	cuelang.org/go v0.13.0-alpha.1.0.20250324111431-1eccc4649d73
	...
	gitlab.wikimedia.org/repos/releng/llbtest v0.0.2
)
...
replace github.com/moby/buildkit v0.20.0 => github.com/moby/buildkit v0.20.0-rc2.0.20250319041228-5efd380c4a81
